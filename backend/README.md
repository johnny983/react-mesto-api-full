# Проектная работа 13. Профессия веб-разработичк. Яндекс.Практикум.

## Описание проекта

Данный проект представляет из себя веб-страницу, созданную с применением технологии HTML, CSS и JavaScript с использованием фреймворка React, серверная часть реализована с помощью Node JS и Express JS.
...
Частично реализована серверная часть.
